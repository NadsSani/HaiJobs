...
public class ExperienceDisplayAdapter extends RecyclerView.Adapter {

    private ArrayList<Experience> experienceArrayList;
    JobSeekerProfile parentObject;

    public ExperienceDisplayAdapter(ArrayList<Experience> data, JobSeekerProfile parent) {
    ...
    public  ItemHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        ...
        ExperienceDisplayAdapter.ItemHolder vh = new ExperienceDisplayAdapter.ItemHolder(v); // pass the view to View Holder
        return vh;
    }
