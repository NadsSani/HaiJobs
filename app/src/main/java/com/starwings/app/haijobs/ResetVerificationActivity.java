...
public class ResetVerificationActivity extends HaiJobsActivity implements
    ...
    private void showUploadPage() {
            ...
            Intent resetPassItnent=new Intent(this,ResetPassActivity.class);
            resetPassItnent.putExtra("mobile",phonenumber);
            startActivity(resetPassItnent);
    ...
    private void startTimer() {
        resend_timer.setClickable(false);
        resend_timer.setTextColor(ContextCompat.getColor(ResetVerificationActivity.this, R.color.sendotp_grey));
        new CountDownTimer(30000, 1000) {
            ...
            public void onFinish() {
                ...
                resend_timer.setTextColor(ContextCompat.getColor(ResetVerificationActivity.this, R.color.colorPrimary));
            }
        }.start();
    }
